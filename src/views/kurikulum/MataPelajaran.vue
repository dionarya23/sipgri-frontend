        ...
        if (this.editedIndex === -1) {
          const isMataPelajaranExist =
            this.mataPelajaran.filter(
              (pelajaran) =>
                pelajaran.mata_pelajaran === this.editedItem.mata_pelajaran &&
                pelajaran.kelompok === this.editedItem.kelompok
            ).length > 0;
          ...
          const isMataPelajaranExist =
            this.mataPelajaran.filter(
              (pelajaran) =>
                (pelajaran.mata_pelajaran === this.editedItem.mata_pelajaran &&
                this.oldMataPelajaran.mata_pelajaran !== pelajaran.mata_pelajaran
                  ) &&
                (pelajaran.kelompok === this.editedItem.kelompok &&
                  this.oldMataPelajaran.kelompok !== pelajaran.kelompok)
            ).length > 0;
